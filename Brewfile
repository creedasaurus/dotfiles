...
brew "buildpacks/tap/pack" # buildpacks
...
brew "dprint"              # pluggable code formatter
...
brew "jdtls"               # Java LSP
brew "jfrog-cli"           # JFrog Artifactory CLI
...
brew "ko"                  # Go container image builder
...
cask "1password"
cask "1password-cli"
cask "activitywatch" # cool local-only activity time tracker
cask "alacritty" # terminal emulator
cask "android-platform-tools" # android tools
cask "appcleaner" # super-delete apps tool
cask "balenaetcher" # USB iso flasher
...
cask "font-monaspace"          # GitHub's variable-width coding font
...
cask "raspberry-pi-imager" # create images for pi
cask "raycast" # <- replace default Spotlight search :thumbs_up:
cask "rectangle" # Screen snapping shortcut tool
cask "scroll-reverser" # Reverse scroll on trackpad vs mouse
cask "spotify" # music
...
cask "vlc" # play any content ever
cask "wezterm" # terminal emulator (2nd place to Ghostty right now)
cask "xcodes-app"          # GUI for xcodes
cask "zed" # cool editor, but not quite there
